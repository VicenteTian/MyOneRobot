...
#define Motor_Roll_Encoder_A_Pin GPIO_PIN_6
#define Motor_Roll_Encoder_A_GPIO_Port GPIOB
#define Motor_Roll_Encoder_B_Pin GPIO_PIN_7
#define Motor_Roll_Encoder_B_GPIO_Port GPIOB
